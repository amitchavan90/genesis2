...
func TestUserRepo_GetMany(t *testing.T) {
	...
	t.Run("wrong ID", func(t *testing.T) {
		...
		result, errs := repo.GetMany([]string{randomID})
		if errs != nil {
	...
	t.Run("one record", func(t *testing.T) {
		...
		result, errs := repo.GetMany([]string{u.ID})
		if len(errs) != 0 {
			t.Errorf("errs: got %v, expected %v", len(errs), 0)
		}
		if len(result) != 1 {
	...
	t.Run("another record", func(t *testing.T) {
		...
		result, errs := repo.GetMany([]string{u1.ID, u2.ID})
		if len(errs) != 0 {
			t.Errorf("errs: got %v, expected %v", len(errs), 0)
		}
		if len(result) != 2 {
...
func TestUserRepo_UserGetByEmail(t *testing.T) {
	...
	t.Run("existing records", func(t *testing.T) {
		...
		result, err := repo.GetByEmail(u.Email.String)
		if err != nil {
...
func TestUserRepo_UserUpdate(t *testing.T) {
	...
	t.Run("update existing", func(t *testing.T) {
		...
		created.Email = null.StringFrom("changed@email.com")
		result, err := repo.Update(created)
		if err != nil {
			t.Errorf("expected nil error, got %v", err)
		}
		if result.Email != null.StringFrom("changed@email.com") {
