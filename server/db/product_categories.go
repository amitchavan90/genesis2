...
type ProductCategory struct {
	...
	L productCategoryL  `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
type (
	...
	ProductCategoryHook func(boil.Executor, *ProductCategory) error
...
func (o *ProductCategory) doBeforeInsertHooks(exec boil.Executor) (err error) {
...
func (o *ProductCategory) doBeforeUpdateHooks(exec boil.Executor) (err error) {
...
func (o *ProductCategory) doBeforeDeleteHooks(exec boil.Executor) (err error) {
...
func (o *ProductCategory) doBeforeUpsertHooks(exec boil.Executor) (err error) {
...
func (o *ProductCategory) doAfterInsertHooks(exec boil.Executor) (err error) {
...
func (o *ProductCategory) doAfterSelectHooks(exec boil.Executor) (err error) {
...
func (o *ProductCategory) doAfterUpdateHooks(exec boil.Executor) (err error) {
...
func (o *ProductCategory) doAfterDeleteHooks(exec boil.Executor) (err error) {
...
func (o *ProductCategory) doAfterUpsertHooks(exec boil.Executor) (err error) {
...
func (q productCategoryQuery) One(exec boil.Executor) (*ProductCategory, error) {
	o := &ProductCategory{}
...
func (q productCategoryQuery) All(exec boil.Executor) (ProductCategorySlice, error) {
...
func (q productCategoryQuery) Count(exec boil.Executor) (int64, error) {
	var count int64
...
func (q productCategoryQuery) Exists(exec boil.Executor) (bool, error) {
	var count int64
...
func (o *ProductCategory) Sku(mods ...qm.QueryMod) stockKeepingUnitQuery {
...
func (productCategoryL) LoadSku(e boil.Executor, singular bool, maybeProductCategory interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.SkuProductCategories = append(foreign.R.SkuProductCategories, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.SkuID == foreign.ID {
				...
				foreign.R.SkuProductCategories = append(foreign.R.SkuProductCategories, local)
				break
			}
		}
	}
...
// SetSku of the productCategory to the related item.
// Sets o.R.Sku to related.
// Adds o to related.R.SkuProductCategories.
func (o *ProductCategory) SetSku(exec boil.Executor, insert bool, related *StockKeepingUnit) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &stockKeepingUnitR{
			SkuProductCategories: ProductCategorySlice{o},
		}
	} else {
		related.R.SkuProductCategories = append(related.R.SkuProductCategories, o)
	}
...
func FindProductCategory(exec boil.Executor, iD string, selectCols ...string) (*ProductCategory, error) {
	...
	err := q.Bind(nil, exec, productCategoryObj)
	if err != nil {
		if errors.Cause(err) == sql.ErrNoRows {
			return nil, sql.ErrNoRows
		}
...
func (o *ProductCategory) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
...
func (q productCategoryQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
...
func (o ProductCategorySlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
...
func (o *ProductCategory) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
...
func (o *ProductCategory) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
...
func (q productCategoryQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
...
func (o ProductCategorySlice) DeleteAll(exec boil.Executor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
...
func (o *ProductCategory) Reload(exec boil.Executor) error {
	ret, err := FindProductCategory(exec, o.ID)
	if err != nil {
		return err
	}
...
func (o *ProductCategorySlice) ReloadAll(exec boil.Executor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
...
func ProductCategoryExists(exec boil.Executor, iD string) (bool, error) {
	var exists bool
