...
type UserActivity struct {
	...
	ObjectID   null.String `db:"object_id" boil:"object_id" json:"object_id,omitempty" toml:"object_id" yaml:"object_id,omitempty"`
	ObjectCode null.String `db:"object_code" boil:"object_code" json:"object_code,omitempty" toml:"object_code" yaml:"object_code,omitempty"`
	ObjectType string      `db:"object_type" boil:"object_type" json:"object_type" toml:"object_type" yaml:"object_type"`
	CreatedAt  time.Time   `db:"created_at" boil:"created_at" json:"created_at" toml:"created_at" yaml:"created_at"`

	R *userActivityR `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L userActivityL  `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
var UserActivityWhere = struct {
	...
	ObjectCode whereHelpernull_String
	...
	ObjectCode: whereHelpernull_String{field: "\"user_activities\".\"object_code\""},
...
var (
	userActivityAllColumns            = []string{"id", "user_id", "action", "object_id", "object_code", "object_type", "created_at"}
	userActivityColumnsWithoutDefault = []string{"user_id", "action", "object_id", "object_code", "object_type"}
...
type (
	...
	// This should generally be used opposed to []UserActivity.
...
func (q userActivityQuery) One(exec boil.Executor) (*UserActivity, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: failed to execute a one query for user_activities")
	}
...
func (q userActivityQuery) All(exec boil.Executor) (UserActivitySlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db: failed to assign all query results to UserActivity slice")
	}
...
func (q userActivityQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to count user_activities rows")
	}
...
func (q userActivityQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db: failed to check if user_activities exists")
	}
...
func FindUserActivity(exec boil.Executor, iD string, selectCols ...string) (*UserActivity, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: unable to select from user_activities")
	}
...
func (o *UserActivity) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db: no user_activities provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to insert into user_activities")
	}
...
func (o *UserActivity) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db: unable to update user_activities, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update user_activities row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by update for user_activities")
	}
...
func (q userActivityQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all for user_activities")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected for user_activities")
	}
...
func (o UserActivitySlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all in userActivity slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected all in update all userActivity")
	}
	return rowsAff, nil
}
...
func (o *UserActivity) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("db: no user_activities provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("db: unable to upsert user_activities, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert user_activities")
	}
...
func (o *UserActivity) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("db: no UserActivity provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete from user_activities")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by delete for user_activities")
	}
...
func (q userActivityQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db: no userActivityQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from user_activities")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by deleteall for user_activities")
	}
...
func (o UserActivitySlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from userActivity slice")
	}
...
func (o *UserActivitySlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to reload all in UserActivitySlice")
	}
...
func UserActivityExists(exec boil.Executor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db: unable to check if user_activities exists")
	}
